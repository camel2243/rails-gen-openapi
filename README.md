...
![Setting the baseUrl value for all requests](./images/baseurl.png)
...
![Updating the create team with the request body from Chrome DevTools](./images/create-team.png)

![Victory!](./images/interceptor.png)
